...
const Header = ({handleMenu}) => {
  ...
  return (
    <div className='flex flex-row bg-[#1b4332] fixed top-0 w-full z-10'>
        ...
        <button className='ml-[55%] mb-[40px] mt-[40px] text-[#fff] flex flex-row hover:text-black m-1 p-2 hover:bg-[#e9ecef] rounded-md transition duration-100' onClick={handleMenu}>
