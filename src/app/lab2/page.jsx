...
const Laboratorio5 = () => { 
  ...
  const fila3 = [
    {computadora: 'PC 06', direccionIP: '10.4.3.17', mascaraSubred: '255.255.255.192', gateWay: '10.4.3.62', iconoPC: <FaComputer size={50}/>},
    {computadora: 'PC 05', direccionIP: 'N/A', mascaraSubred: 'N/A', gateWay: 'N/A', iconoPC: <FaComputer size={50}/>},
    {computadora: 'PC 04', direccionIP: 'N/A', mascaraSubred: 'N/A', gateWay: 'N/A', iconoPC: <FaComputer size={50}/>},
    {computadora: 'PC 03', direccionIP: 'N/A', mascaraSubred: 'N/A', gateWay: 'N/A', iconoPC: <FaComputer size={50}/>},
    {computadora: 'PC 02', direccionIP: '10.4.3.13', mascaraSubred: '255.255.255.192', gateWay: '10.4.3.62', iconoPC: <FaComputer size={50}/>},
    {computadora: 'PC 01', direccionIP: '10.4.3.12', mascaraSubred: '255.255.255.192', gateWay: '10.4.3.62', iconoPC: <FaComputer size={50}/>},
  ]

  const fila2 = [
    {computadora: 'PC 05', direccionIP: '10.4.3.10', mascaraSubred: '255.255.255.192', gateWay: '10.4.3.62', iconoPC: <FaComputer size={50}/>},
    {computadora: 'PC 04', direccionIP: 'N/A', mascaraSubred: 'N/A', gateWay: 'N/A', iconoPC: <FaComputer size={50}/>},
    {computadora: 'PC 03', direccionIP: '10.4.3.8', mascaraSubred: '255.255.255.192', gateWay: '10.4.3.62', iconoPC: <FaComputer size={50}/>},
    {computadora: 'PC 02', direccionIP: 'N/A', mascaraSubred: 'N/A', gateWay: 'N/A', iconoPC: <FaComputer size={50}/>},
    {computadora: 'PC 01', direccionIP: 'N/A', mascaraSubred: 'N/A', gateWay: 'N/A', iconoPC: <FaComputer size={50}/>},
  ]

  const fila1 = [
    {computadora: 'PC 05', direccionIP: '10.4.3.5', mascaraSubred: '255.255.255.192', gateWay: '10.4.3.62', iconoPC: <FaComputer size={50}/>},
    {computadora: 'PC 04', direccionIP: '140.10.1.219', mascaraSubred: '255.255.248.0', gateWay: '140.10.7.254', iconoPC: <FaComputer size={50}/>},
    {computadora: 'PC 03', direccionIP: 'N/A', mascaraSubred: 'N/A', gateWay: 'N/A', iconoPC: <FaComputer size={50}/>},
    {computadora: 'PC 02', direccionIP: '10.4.3.2', mascaraSubred: '255.255.255.192', gateWay: '10.4.3.62', iconoPC: <FaComputer size={50}/>},
    {computadora: 'PC 01', direccionIP: 'N/A', mascaraSubred: 'N/A', gateWay: 'N/A', iconoPC: <FaComputer size={50}/>},
  ]
  ...
  return (
    <main className={`grid ${abrirMenu ? 'grid-cols-5 ' : 'grid-cols-1 h-screen mt-[200px] '} mt-[130px]`}>
        ...
        <div className={`${abrirMenu ? 'col-span-4' : 'col-span-1 '} bg-[#fff]`}>
            <div className='m-10 p-3 text-center text-[30px] text-[#f5f3f4] font-extrabold rounded-lg bg-[#495057]'>Laboratorio de cómputo 02</div>
